...
if __name__ == "__main__":
    ...
    env_f, param_env_bounds, initial_dist, target_dist = (
        EnvironmentArgsHandler.get_object_from_arguments(args)
    )

    state_dim = env_f().observation_space.shape[0]
    action_dim = env_f().action_space.shape[0]
    ...
    student_function = StudentArgsHandler.get_object_from_arguments(
        args, env_f, Teacher
    )
    print("Training...")
    student_function()
