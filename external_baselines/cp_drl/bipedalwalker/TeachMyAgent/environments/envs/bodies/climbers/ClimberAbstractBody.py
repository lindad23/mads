...
class ClimberAbstractBody(WalkerAbstractBody):
    ...
    def __init__(self, scale, motors_torque, nb_steps_under_water):
        ...
        """
        super(ClimberAbstractBody, self).__init__(
    ...
    def get_state_size(self):
        ...
        """
        return super(ClimberAbstractBody, self).get_state_size() + len(
    ...
    def get_sensors_state(self):
        ...
        for sensor in self.sensors:
            state.extend(
                [
                    1.0 if sensor.userData.has_contact else 0.0,
    ...
    def destroy(self, world):
        super(ClimberAbstractBody, self).destroy(
            world
        )  # Destroy the rest of the body as any other agent
        for sensor in self.sensors:
