...
HULL_POLYGONS = [[(-30, +9), (+6, +9), (+34, +1), (+34, -8), (-30, -8)]]
...
class SmallBipedalBody(WalkerAbstractBody):
    """
    Short bipedal walker implemented in https://github.com/flowersteam/teachDeepRL.
    """
    ...
    def __init__(
        ...
        """
        Creates a short bipedal walker.
        ...
        """
        super(SmallBipedalBody, self).__init__(
        ...
        self.AGENT_HEIGHT = 17 / self.SCALE + self.LEG_H * 2 - self.LEG_DOWN
    ...
    def draw(self, world, init_x, init_y, force_to_center):
        ...
        hull = world.CreateDynamicBody(
            position=(init_x, init_y), fixtures=HULL_FIXTURES
        )
        ...
        hull.userData = CustomBodyUserData(
            True, is_contact_critical=self.reset_on_hull_critical_contact, name="hull"
        )
