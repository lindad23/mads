...
class SpiderBody(WalkerAbstractBody):
    ...
    def __init__(
        ...
        # not exact but works
        self.AGENT_WIDTH = MAIN_BODY_BOTTOM_WIDTH / self.SCALE + self.LEG_H * 4
        self.AGENT_HEIGHT = 20 / self.SCALE + self.LEG_H * 2
    ...
    def draw(self, world, init_x, init_y, force_to_center):
        ...
        main_body = world.CreateDynamicBody(
            position=(init_x, init_y), fixtures=MAIN_BODY_FIXTURES
        )
        ...
        for i in [+1, -1] * self.nb_pairs_of_legs:
            ...
            upper_leg_x = (
                init_x
                - i * MAIN_BODY_BOTTOM_WIDTH / self.SCALE / 2
            ...
            rjd = revoluteJointDef(
                ...
                bodyB=upper_leg,
                anchor=(
                    init_x - i * MAIN_BODY_BOTTOM_WIDTH / self.SCALE / 2,
            ...
            rjd = revoluteJointDef(
                ...
                bodyB=middle_leg,
                anchor=(
                    upper_leg_x - upper_leg_x_distance,
            ...
            rjd = revoluteJointDef(
                ...
                bodyB=lower_leg,
                anchor=(
                    middle_leg_x - middle_leg_x_distance,
            ...
            joint_motor.userData = CustomMotorUserData(
                SPEED_KNEE, True, contact_body=lower_leg
            )
            self.motors.append(joint_motor)
