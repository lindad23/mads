...
from TeachMyAgent.environments.envs.bodies.climbers.ClimbingChestProfileChimpanzee import (
    ClimbingChestProfileChimpanzee,
)
from TeachMyAgent.environments.envs.bodies.climbers.ClimbingProfileChimpanzee import (
    ClimbingProfileChimpanzee,
)

from TeachMyAgent.environments.envs.bodies.swimmers.FishBody import FishBody

from TeachMyAgent.environments.envs.bodies.amphibians.AmphibiousBipedalBody import (
    AmphibiousBipedalBody,
)

from TeachMyAgent.environments.envs.bodies.walkers.old.OldBigQuadruBody import (
    OldBigQuadruBody,
)
from TeachMyAgent.environments.envs.bodies.walkers.old.OldClassicBipedalBody import (
    OldClassicBipedalBody,
)
from TeachMyAgent.environments.envs.bodies.walkers.SmallBipedalBody import (
    SmallBipedalBody,
)
from TeachMyAgent.environments.envs.bodies.walkers.BigQuadruBody import BigQuadruBody
from TeachMyAgent.environments.envs.bodies.walkers.ClassicBipedalBody import (
    ClassicBipedalBody,
)
from TeachMyAgent.environments.envs.bodies.walkers.MillipedeBody import MillipedeBody
from TeachMyAgent.environments.envs.bodies.walkers.ProfileChimpanzee import (
    ProfileChimpanzee,
)
