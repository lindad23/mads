...
class CustomMotorUserData(CustomUserData):
    ...
    def __init__(
        self, speed_control, check_contact, angle_correction=0.0, contact_body=None
    ):
        """
        ...
        """
        super(CustomMotorUserData, self).__init__(
            "motor", CustomUserDataObjectTypes.MOTOR
        )
...
class CustomBodySensorUserData(CustomBodyUserData):
    ...
    def __init__(
        ...
        super(CustomBodySensorUserData, self).__init__(
