...
import numpy as np
from TeachMyAgent.students.openai_baselines.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(
        [
            ...
            "python",
            "-c",
            "from TeachMyAgent.students.openai_baselines.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()",
        ]
    )
