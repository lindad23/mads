...
from TeachMyAgent.students.openai_baselines.common.atari_wrappers import (
    make_atari,
    wrap_deepmind,
)
from TeachMyAgent.students.openai_baselines.common.vec_env.subproc_vec_env import (
    SubprocVecEnv,
)
from TeachMyAgent.students.openai_baselines.common.vec_env.dummy_vec_env import (
    DummyVecEnv,
)
...
def make_mujoco_env(env_id, seed, reward_scale=1.0):
    ...
    env.seed(seed)
    if reward_scale != 1.0:
        from TeachMyAgent.students.openai_baselines.common.retro_wrappers import (
            RewardScaler,
        )
