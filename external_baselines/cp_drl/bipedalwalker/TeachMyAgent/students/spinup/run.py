import TeachMyAgent.students
from TeachMyAgent.students.spinup.user_config import DEFAULT_BACKEND
from TeachMyAgent.students.spinup.utils.run_utils import ExperimentGrid
...
if __name__ == "__main__":
    ...
    if cmd in valid_help:
        ...
        help_msg = (
            ...
            \tpython -m students.run CMD [ARGS...]
        ...
        special_info = (
            ...
            \tpython -m students.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m students.run [algo] --help
