...
def package_to_hub(
    repo_id, ta_config, model_path, mean_reward, std_reward, hyperparameters, token=None
):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        subprocess.run(
            'tensorflowjs_converter --input_format=tf_saved_model --output_node_names="parkour_walker" '
        ...
        generated_model_card, metadata = _generate_model_card(
            ta_config["name"], mean_reward, std_reward, hyperparameters
        )
