...
class CarRacingBezierAdversarial(CarRacingBezier):
    ...
    sparse_rewards=False,
		...
		super().__init__(
			...
			animate_zoom=False,
			min_rad_ratio=min_rad_ratio if min_rad_ratio is not None else 0.333333333,
			max_rad_ratio=max_rad_ratio if max_rad_ratio is not None else 1.0,
...
class CarRacingBezierAdversarialTask0(CarRacingBezierAdversarial):
	def __init__(self, **kwargs):
		kwargs.pop('n_control_points', None)
		kwargs.pop('min_rad_ratio', None)
		kwargs.pop('max_rad_ratio', None)
		super().__init__(n_control_points=8, min_rad_ratio=0.85, max_rad_ratio=1.0, **kwargs)


class CarRacingBezierAdversarialTask1(CarRacingBezierAdversarial):
	def __init__(self, **kwargs):
		kwargs.pop('n_control_points', None)
		kwargs.pop('min_rad_ratio', None)
		kwargs.pop('max_rad_ratio', None)
		super().__init__(n_control_points=10, min_rad_ratio=0.65, max_rad_ratio=1.0, **kwargs)


class CarRacingBezierAdversarialTask2(CarRacingBezierAdversarial):
	def __init__(self, **kwargs):
		kwargs.pop('n_control_points', None)
		kwargs.pop('min_rad_ratio', None)
		kwargs.pop('max_rad_ratio', None)
		super().__init__(n_control_points=12, min_rad_ratio=0.45, max_rad_ratio=1.0, **kwargs)


class CarRacingBezierAdversarialTask3(CarRacingBezierAdversarial):
	def __init__(self, **kwargs):
		kwargs.pop('n_control_points', None)
		kwargs.pop('min_rad_ratio', None)
		kwargs.pop('max_rad_ratio', None)
		super().__init__(n_control_points=16, min_rad_ratio=0.25, max_rad_ratio=1.0, **kwargs)
...
gym_register(
	id='CarRacing-Bezier-Adversarial-Task0-v0',
	entry_point=module_path + ':CarRacingBezierAdversarialTask0',
	max_episode_steps=1000,
	reward_threshold=900)

gym_register(
	id='CarRacing-Bezier-Adversarial-Task1-v0',
	entry_point=module_path + ':CarRacingBezierAdversarialTask1',
	max_episode_steps=1000,
	reward_threshold=900)

gym_register(
	id='CarRacing-Bezier-Adversarial-Task2-v0',
	entry_point=module_path + ':CarRacingBezierAdversarialTask2',
	max_episode_steps=1000,
	reward_threshold=900)

gym_register(
	id='CarRacing-Bezier-Adversarial-Task3-v0',
	entry_point=module_path + ':CarRacingBezierAdversarialTask3',
	max_episode_steps=1000,
	reward_threshold=900)
